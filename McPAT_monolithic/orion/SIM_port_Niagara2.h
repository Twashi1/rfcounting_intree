...
#define PARM_TECH_POINT       14
#define PARM_TRANSISTOR_TYPE  NVT   /* transistor type, HVT, NVT, or LVT */
#define PARM_Vdd              0.8
#define PARM_Freq             1.4e9
#define Monolithic_type  	  0   /* Monolithic implementaion type, 0 or 1. 0 is for block-level monolithic, 1 is for transistor-level monolithic. */

/* router module parameters */
/* general parameters */
#define PARM_in_port 		9	/* # of router input ports */
...
#define PARM_flit_width		136	/* flit width in bits */

/* virtual channel parameters */
#define PARM_v_class        1   /* # of total message classes */
#define PARM_v_channel		16	/* # of virtual channels per virtual message class*/
...
/* crossbar parameters */
#define PARM_crossbar_model	MATRIX_CROSSBAR // MULTREE_CROSSBAR	/* crossbar model type MATRIX_CROSSBAR or MULTREE_CROSSBAR*/ 
...
#define PARM_in_buf			2		/* have input buffer? */
...
#define PARM_router_diagonal    1790  	/*router diagonal in micro-meter block-level monolithic*/
#elif(Monolithic_type == 1) 
#define PARM_router_diagonal    1680  	/*router diagonal in micro-meter transistor-level monolithic*/
#endif
#else
