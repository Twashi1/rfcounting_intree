...
double DFF_TAB[1] = {194.7e-9};
#elif (PARM(TECH_POINT) > 14 && PARM(TECH_POINT) <= 65 && PARM(TRANSISTOR_TYPE) == LVT) 
...
#elif (PARM(TECH_POINT) > 14 && PARM(TECH_POINT) <= 65 && PARM(TRANSISTOR_TYPE) == NVT) 
...
#elif (PARM(TECH_POINT) > 14 && PARM(TECH_POINT) <= 65 && PARM(TRANSISTOR_TYPE) == HVT) 
...
#elif (PARM(TECH_POINT) == 14)  // Apo. Leakage values for 14nm FinFET technology.
double NMOS_TAB[1] = {1.1405e-9};
double PMOS_TAB[1] = {0.0643e-9};
double INV2_TAB[1] =  {0.6346e-9};
double NAND2_TAB[4] = {0.7146e-9, 0.7146e-9, 0.7146e-9, 0.7146e-9};		// Average leakage current
double NOR2_TAB[4] ={0.7220e-9, 0.7220e-9, 0.7220e-9, 0.7220e-9};		// Average leakage current
double DFF_TAB[1] = {3.49275e-9};
