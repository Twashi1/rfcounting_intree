...
#define PARM_Vdd              0.8
#define PARM_Freq             1.2e9
#define Monolithic_type  	  1   /* Monolithic implementaion type, 0 or 1. 0 is for block-level monolithic, 1 is for transistor-level monolithic. */
...
#define PARM_v_channel		8	/* # of virtual channels per virtual message class*/
...
#define PARM_router_diagonal    125  	/*router diagonal in micro-meter block-level monolithic*/
#elif(Monolithic_type == 1) 
#define PARM_router_diagonal    100  	/*router diagonal in micro-meter transistor-level monolithic*/
#endif
#else
