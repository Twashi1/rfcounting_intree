...
#define SCALE_BW (0.53) 
#define SCALE_Crs (0.49) 
#elif (PARM(TECH_POINT) == 14)  
#define SCALE_T 1 // Not used in 14nm.
#define SCALE_S 1
...
#elif(PARM(TECH_POINT) <= 65 && PARM(TECH_POINT) > 14) 
...
#if(Monolithic_type == 0) 
#define scale 	1
#define scaleM 	1
#elif(Monolithic_type == 1) 
#define scale 	54/84					// logic gate scaling
#define scaleM 	32/57 					// memory cell scaling
#endif

#define LSCALE 	0.087					// Not used for 14nm
#define MSCALE  (LSCALE * .624 / .2250) // Not used for 14nm

/* bit width of RAM cell in um */
#define BitWidth  	(0.399)*scaleM 		// 57 lamda     

/* bit height of RAM cell in um */
#define BitHeight   (0.140)     		// 20 lamda 

#define Cout        1e-15  			

/* Sizing of cells and spacings */
#define BitlineSpacing   0.080			// Only used for buffers. We handle buffers using CACTI-monolithic.
#define WordlineSpacing  0.080			 

#define RegCellHeight    0.140			// 20 lamda, 6T sram cell
#define RegCellWidth     0.399*scaleM	// 57 lamda for 2D cell, 32 lamda for 3D cell implemented in transistor-level monolithic 

#define Cwordmetal    (1.63e-15)  		// Only used for buffers.
#define Cbitmetal     (3.27e-15)  

#define Cmetal        (0.146204e-15)
#define CM2metal      (0.146204e-15) 
#define CM3metal      (0.146204e-15)

// minimum spacing
#define CCmetal       (0.146204e-15)	// PTM model using parameters: w=s=26nm, t=h=52nm (obtained from ITRS 2013 and Intel 14nm technology) 
#define CCM2metal     (0.146204e-15) 
#define CCM3metal     (0.146204e-15) 
// 2x minimum spacing
#define CC2metal      (0.09844e-15) 
#define CC2M2metal    (0.09844e-15) 
#define CC2M3metal    (0.09844e-15) 
...
/* corresponds to clock network*/
#define Clockwire 	1.85e-10			// ITRS 2013: global wire capacitance per unit length
#define Reswire   	5.13e+06 			// ITRS 2013: global wire resistance per unit length = resistivity/(width*thickness) = 3e-8/(50e-9*117e-9). Not used.
					
/* um */
#define Leff          (0.0696)			// Not used for 14nm.
/* length unit in um */
#define Lamda         (Leff * 0.5)		// Matters for MULTREE_CROSSBAR. CHECK

/* fF/um */
#define Cpolywire   (1.832e-15) 		// Not used in 14nm. 
/* ohms*um of channel width */
#define Rnchannelstatic (2244.6)  		// Not used in 14nm. 
/* ohms*um of channel width */
#define Rpchannelstatic (5324.4)  		// Not used in 14nm. 
#define Rnchannelon (2540)				// Not used in 14nm. 
#define Rpchannelon (5791)				// Not used in 14nm. 

#define Rbitmetal   (1.92644)   		/* derived from Cacti 5.3 Not used in 14nm. */  
#define Rwordmetal  (1.31948)  			/* derived from Cacti 5.3 Not used in 14nm. */

#define Vt	0.285

#define CamCellHeight    (0.140)  		// 20 lamda. Only used for buffers.
#define CamCellWidth     (0.623)		// 89 lamda.

#define MatchlineSpacing (0.522)   		// Only used for buffers.
#define TaglineSpacing   (0.522)   

#define CrsbarCellHeight (0.588)*scale   
#define CrsbarCellWidth  (0.644) 		// TRISATE: 2 INV+ NAND + NOR

#define krise       (0.348e-10) 		// Only used for buffers. CHECK
#define tsensedata  (0.5046e-10)   
#define tsensetag   (0.2262e-10)  
#define tfalldata   (0.609e-10)  
#define tfalltag    (0.6609e-10) 
			
#define Wdecdrivep      (24)		// Calculated from 65nm NVT transistors using the formula Size = (Wold_tech_width/Lold_tech_node*Lnew_tech_node/Wnew_tech_width) to find the fin numbers.
#define Wdecdriven      (17)		// Use nFinFET fin numbers as the reference for the gate size
#define Wdec3to8n       (5)			// i.e. 6.7/0.065*0.014/0.060 = 24.05. For 14nm tech the Fin heigth is 30nm and the corresponding width is 2*Hfin=60nm
#define Wdec3to8p       (5)
#define WdecNORn        (4)
#define WdecNORp        (9)
#define Wdecinvn        (5)
...
#define Wworddrivemax   (33)
#define Wmemcella   (1.0)
#define Wmemcellr   (1.0)
#define Wmemcellw   (1.0)
#define Wmemcellbscale  (7.0)
#define Wbitpreequ  (3)

#define Wbitmuxn    (3)
#define WsenseQ1to4 (1)
#define Wcompinvp1  (3)
#define Wcompinvn1  (2)
#define Wcompinvp2  (7)
#define Wcompinvn2  (4)
#define Wcompinvp3  (13)
#define Wcompinvn3  (8)
#define Wevalinvp   (7)
#define Wevalinvn   (26)
...
#define Wcompn      (7)
#define Wcompp      (10)
#define Wcomppreequ     (13)
#define Wmuxdrv12n  (10)
#define Wmuxdrv12p  (17)
#define WmuxdrvNANDn    (7)
#define WmuxdrvNANDp    (26)
#define WmuxdrvNORn (20)
#define WmuxdrvNORp (26)
#define Wmuxdrv3n   (66)
#define Wmuxdrv3p   (159)
#define Woutdrvseln (4)
#define Woutdrvselp (7)
#define Woutdrvnandn    (8)
#define Woutdrvnandp    (3)
#define Woutdrvnorn (2)
#define Woutdrvnorp (13)
#define Woutdrivern (16)
#define Woutdriverp (26)
#define Wbusdrvn    (16)
#define Wbusdrvp    (26)

#define Wcompcellpd2    (1)
#define Wcompdrivern    (132)
#define Wcompdriverp    (265)
#define Wcomparen2      (13)
#define Wcomparen1      (7)
#define Wmatchpchg      (3)
#define Wmatchinvn      (3)
#define Wmatchinvp      (7)
#define Wmatchnandn     (7)
#define Wmatchnandp     (3)
#define Wmatchnorn      (7)
#define Wmatchnorp      (3)

#define WSelORn         (3)
#define WSelORprequ     (13)
#define WSelPn          (3)
#define WSelPp          (5)
#define WSelEnn         (2)
#define WSelEnp         (3)

#define Wsenseextdrv1p  (13)
#define Wsenseextdrv1n  (8)
#define Wsenseextdrv2p  (66)
#define Wsenseextdrv2n  (40)
...
#elif(PARM(TECH_POINT) == 14) /* PARAMETERS for Link at 14nm */ // From ITRS 2013
#if (WIRE_LAYER_TYPE == LOCAL)
#define WireMinWidth                    26e-9
#define WireMinSpacing                  26e-9
#define WireMetalThickness              52e-9
#define WireBarrierThickness            1.5e-9
#define WireDielectricThickness         52e-9	
#define WireDielectricConstant          2.2
...
#elif (WIRE_LAYER_TYPE == GLOBAL)
#define WireMinWidth                50e-9 
#define WireMinSpacing              50e-9
#define WireMetalThickness          117e-9 	// Aspect ratio is 2.34
#define WireBarrierThickness        1.5e-9
#define WireDielectricThickness     100e-9 
#define WireDielectricConstant      2.2

#endif /* WIRE_LAYER_TYPE for 14nm*/
...
/*parameters for insertion buffer for links at 14nm*/ 
#elif(PARM(TECH_POINT) == 14)
#define BufferDriveResistance       3.3185e+03		
#define BufferIntrinsicDelay        4.115e-13 	// Rout*Cout
#define BufferWidth					0.126		// 18 lamda = 0.126 um		
#define BufferHeight				0.588		// 84 lamda = 0.588 um 
#define BufferPMOSOffCurrent        0.0643e-09 
#define BufferNMOSOffCurrent        1.1405e-09
#define BufferInputCapacitance      0.3743e-15
#define ClockCap                    0.2544e-15	// 2 * NAND
#endif /*PARM(TECH_POINT)*/
...
#elif(PARM(TECH_POINT) == 14)
#define AreaNOR     (0.115)*scale   	// NOR 1x: 28x84 lamda
#define AreaINV     (0.074)*scale   	// INV 1x: 18x84 lamda
#define AreaDFF     (0.642)*scale  		// 156x84 lamda
#define AreaAND     (0.115)*scale   	// NAND 1x: 28x84 lamda
#define AreaMUX2    (0.419)*scale   	// 1 INV + 3 NAND 
#define AreaMUX3    (0.608)*scale  		// 2 INV + 4 NAND 
#define AreaMUX4    (0.723)*scale  		// 2 INV + 5 NAND 
#endif

/*======================Parameters for FinFET 14nm===========================*/
#if(PARM(TECH_POINT) == 14)
#define CapGateNFET      (0.1326e-15)  
#define CapDrainNFET     (0.0411e-15) 
#define CapGatePFET      (0.1328e-15)  
#define CapDrainPFET     (0.0392e-15) 
