...
// NOTE: CUSTOM CODE I ADDED
// TODO: ideally take an argument
__attribute__((used)) static inline void ext_set_sim_cmd(void) {
  SimSetOwnFreqMHz(3400);
}

__attribute__((used)) static inline void ext_set_roi_start(void) {
  SimRoiStart();
}

__attribute__((used)) static inline void ext_set_roi_end(void) { SimRoiEnd(); }
