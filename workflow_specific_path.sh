...
rm -f ./stats/${test_name}_path_STD.csv
...
sudo python3 ./scripts/mcpat_to_ptrace.py --mcpat_outs="./mcpat_out/${test_name}" --module_index=2 --aggregate=likely --mcpat_ins="./mcpat_inputs/${test_name}" --stats="./stats/${test_name}_path_STD.csv"
...
# Calculate EDP
sudo python3 ./scripts/calc_energy_efficiency.py --stats="./stats/${test_name}_path_STD.csv" --mcpat_ins="./mcpat_inputs/${test_name}" --mcpat_outs="./mcpat_out/${test_name}" --new_voltage_levels="./block_heats/${test_name}_OutVoltages.csv" --file_prefix="${test_name}"
